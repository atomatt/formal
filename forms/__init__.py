...
try:
    ...
    defaultJS = static.File(os.path.join(os.path.split(__file__)[0], 'forms.js'))
else:
    ...
    defaultJS = LazyResource(lambda: static.File(pkg_resources.resource_filename('forms', 'forms.js')))
    del LazyResource
